...
class Preprocess:
    def __init__(
        ...
        if self.find_best_rotation:
            ...
            os.makedirs(self.crop_path, exist_ok=True)
    ...
    def __call__(self, image, return_score=False):
        ...
        if self.find_best_rotation:
            ...
            for i in range(num_crops):
                single_crop_path = os.path.join(self.crop_path, f'{i}.png')
...
class OCR:
    def __init__(self, config_path=None, weight_path=None, model_name=None):
        ...
        ocr_config['device'] = 'cuda:0' if torch.cuda.is_available() else 'cpu'
