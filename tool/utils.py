...
weight_url = {
    ...
    "pan_resnet18_sroie19": "1-QvIN0MrP28URQILYvLaF1G1eTx2oh8W" , # PANNet_best_map
    "transformerocr_mcocr": "1qpXp_-digz2HPTGY_GPdwstzGLhjC_ot", # transformerocr
    "transformerocr_default_vgg": "13327Y1tz1ohsm5YZMyXVMPIOjoOA0OaA", # missing
    "transformerocr_default_resnet50": "12dTOZ9VP7ZVzwQgVvqBWz5JO5RXXW5NY", # missing
    "transformerocr_default_resnet50_fpn": "12dTOZ9VP7ZVzwQgVvqBWz5JO5RXXW5NY", # missing
...
def from_colorname_to_bgr(color):
    # Lazy import to avoid heavy deps during simple utility imports
...
# Note: color_list is computed lazily inside visualize() to avoid heavy imports at module import time.
...
def visualize(
    ...
    """
    # Lazy imports to avoid import-time errors when only using download utilities
    import cv2  # type: ignore
    import numpy as np  # type: ignore
    import matplotlib  # type: ignore
    import matplotlib.pyplot as plt  # type: ignore
    from modules.detection import draw_bbox  # type: ignore

    # compute color list lazily
